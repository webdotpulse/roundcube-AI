...
assert_true(!is_dir($tempDir . '/skins/gmail'), "Skin 'gmail' is not installed (removed)");
...
assert_true(strpos($updatedConfig, "'easy_unsubscribe'") !== false, "easy_unsubscribe added to plugins array in config");
