...
ALTER TABLE xcalendar_alarms ADD alarm_position SMALLINT NOT NULL DEFAULT 0;
...
ALTER TABLE xcalendar_alarms ADD alarm_type SMALLINT NOT NULL DEFAULT 0;
ALTER TABLE xcalendar_alarms ADD processing_started SMALLINT NOT NULL DEFAULT 0;

DROP INDEX user_event_end;
CREATE INDEX xcalendar_alarms_time_type_end_user ON xcalendar_alarms (alarm_time, alarm_type, event_end, user_id);
